    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "border-solid [border-image-source:url('/warcraftcn/card-bg.webp')] [border-image-repeat:stretch] border-12 [border-image-slice:12_fill]",
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      data-inset={inset}
      className={cn(
        "fantasy relative flex cursor-pointer select-none items-center gap-2 px-3 py-2 text-sm text-amber-100 outline-none transition-all",
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "fantasy px-3 py-2 text-xs font-semibold uppercase tracking-wider text-amber-400/80",
        "data-[inset]:pl-8",
        className
      )}
      {...props}
